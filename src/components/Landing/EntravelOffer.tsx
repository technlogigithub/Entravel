...
const EntravelOffer = () => {
  return (
    <Container>
      ...
      <div className="flex gap-4 mt-20 px-3">
        <div className="basis-3/4">
          ...
          <div className="flex gap-4 mt-4">
            <div className="basis-3/5 card-shadow bg-white rounded-sm overflow-hidden px-8 py-6">
            ...
            <div className="basis-2/5 card-shadow bg-white rounded-sm overflow-hidden px-8 py-6 flex flex-col">
        ...
        <div className="basis-1/4">
          ...
          {/* Seocnd Section */}
          <div className="card-shadow bg-white rounded-sm overflow-hidden px-8 py-6 mt-4">
            <p className="font-18 pb-12">
