...
interface ReferralLinkProps {
  isNewGenerateLink?: boolean;
}
const ReferralLink: FC<ReferralLinkProps> = ({ isNewGenerateLink = false }) => {
  ...
  return (
    <div className="p-6 sm:py-4 sm:px-4 2xlg:px-10 bg-blue-50 rounded shadow-six border border-input flex flex-col items-center justify-center text-center">
      ...
      <h4 className="text-lg font-semibold pt-3  pb-3 uppercase">
        your Referral Link
      </h4>
            ...
            <>
              ...
              <div className="flex gap-6 sm:gap-2 w-full max-sm:flex-wrap">
                <div className="relative w-full">
                  ...
                  <Button
                    variant="link"
                    className="gap-3 text-base absolute right-0 top-1 text-primary hover:!text-blue"
                  >
                ...
                <Button
                  className="gap-3 rounded-xl min-w-36 px-4 max-sm:w-full max-sm:h-12"
                  size="lg"
                >
                  <IconLink />
                  Copy link
