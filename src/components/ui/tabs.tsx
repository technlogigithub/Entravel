...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "flex h-9 items-center justify-start border-b border-input p-1 text-black-secondary",
      className
    )}
    {...props}
  />
